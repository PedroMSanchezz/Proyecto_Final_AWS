...
<header>
          ...
          <div class="row">
            <div class="col-sm-8 col-md-7 py-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="loginproveedores.html" class="text-white">Iniciar sesión</a></li>
		<li><a href="altaproductos.php" class="text-white">¡Sube un producto!</a></li>
      ...
      <div class="navbar navbar-dark bg-dark box-shadow">
        ...
        <img src="https://valenciaplaza.com/public/Image/2021/4/culturplaza_151_01_NoticiaAmpliada.jpg" style="display: block; margin: auto; margin-top: 20px; width: 55%; height: 80%; object-fit: cover;">
